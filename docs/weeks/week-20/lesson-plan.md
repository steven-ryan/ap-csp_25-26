---
title: Week 20 — Lesson Plan
---
{% include topnav.md %}

# Week 20 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Create PT — Prototype List + Procedure
...
Create PT note
- Create PT: prototype list operations and parameterized procedure; start testing plan.
...
- Review and merge student PRs for Week 20 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 20 > /tmp/week-20-summary.md
  - Open /tmp/week-20-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-20/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-20/quiz.html
