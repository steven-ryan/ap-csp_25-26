---
title: Week 12 — Lesson Plan
---
{% include topnav.md %}

# Week 12 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Internet — Reliability/Redundancy
...
- Review and merge student PRs for Week 12 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 12 > /tmp/week-12-summary.md
  - Open /tmp/week-12-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-12/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-12/quiz.html
