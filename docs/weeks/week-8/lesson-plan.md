...
# Week 8 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Unit 1 — Debugging/Testing
...
- Review and merge student PRs for Week 08 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 08 > /tmp/week-08-summary.md
  - Open /tmp/week-08-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-8/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-8/quiz.html
