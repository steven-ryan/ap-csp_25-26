...
# Week 3 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Continue Unit 1 — Loops/Patterns
...
- Review and merge student PRs for Week 03 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 03 > /tmp/week-03-summary.md
  - Open /tmp/week-03-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-3/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-3/quiz.html
