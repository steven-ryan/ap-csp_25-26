---
title: Week 11 — Lesson Plan
---
{% include topnav.md %}

# Week 11 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Internet — Addressing/Packets/Protocols
...
- AP Classroom (15–20 min): CSN (Internet addressing, DNS, packets, protocols)
- Barron’s (20–30 min): Internet: addressing, DNS, packets, protocols
...
- Review and merge student PRs for Week 11 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 11 > /tmp/week-11-summary.md
  - Open /tmp/week-11-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-11/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-11/quiz.html
