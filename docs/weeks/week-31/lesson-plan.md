...
- Review and merge student PRs for Week 31 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 31 > /tmp/week-31-summary.md
  - Open /tmp/week-31-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-31/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-31/quiz.html
