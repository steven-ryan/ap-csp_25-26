---
title: Week 21 — Lesson Plan
---
{% include topnav.md %}

# Week 21 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Create PT — Iteration & Testing Plan
...
- Review and merge student PRs for Week 21 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 21 > /tmp/week-21-summary.md
  - Open /tmp/week-21-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-21/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-21/quiz.html
