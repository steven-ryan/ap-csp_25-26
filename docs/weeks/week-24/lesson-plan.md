---
title: Week 24 — Lesson Plan
---
{% include topnav.md %}

# Week 24 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Create PT — Build Sprint 2
...
- Review and merge student PRs for Week 24 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 24 > /tmp/week-24-summary.md
  - Open /tmp/week-24-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-24/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-24/quiz.html
