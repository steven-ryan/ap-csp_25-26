---
title: Week 5 — Lesson Plan
---
{% include topnav.md %}

# Week 5 — MakeCode CSP Wrapper
...
- Review and merge student PRs for Week 05 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 05 > /tmp/week-05-summary.md
  - Open /tmp/week-05-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-5/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-5/quiz.html
