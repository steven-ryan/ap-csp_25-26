---
title: Week 7 — Lesson Plan
---
{% include topnav.md %}

# Week 7 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Unit 1 — Data Inputs/Validation
...
- AP Classroom (15–20 min): AAP‑2.* (lists, traversals), Code analysis
- Barron’s (20–30 min): Lists/Strings; Tracing & Debugging
...
- Review and merge student PRs for Week 07 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 07 > /tmp/week-07-summary.md
  - Open /tmp/week-07-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-7/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-7/quiz.html
