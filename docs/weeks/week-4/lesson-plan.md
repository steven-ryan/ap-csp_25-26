...
# Week 4 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Unit 1 — Functions/Abstraction
...
- Review and merge student PRs for Week 04 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 04 > /tmp/week-04-summary.md
  - Open /tmp/week-04-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-4/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-4/quiz.html
