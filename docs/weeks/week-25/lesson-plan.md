---
title: Week 25 — Lesson Plan
---
{% include topnav.md %}

# Week 25 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Create PT — Build Sprint 3
...
- Review and merge student PRs for Week 25 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 25 > /tmp/week-25-summary.md
  - Open /tmp/week-25-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-25/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-25/quiz.html
