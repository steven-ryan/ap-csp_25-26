---
title: Week 28 — Lesson Plan
---
{% include topnav.md %}

# Week 28 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: MC Practice — Pseudocode/Tracing
...
- Review and merge student PRs for Week 28 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 28 > /tmp/week-28-summary.md
  - Open /tmp/week-28-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-28/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-28/quiz.html
