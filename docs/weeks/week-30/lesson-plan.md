---
title: Week 30 — Lesson Plan
---
{% include topnav.md %}

# Week 30 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Full‑length Practice Exam A
...
- Review and merge student PRs for Week 30 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 30 > /tmp/week-30-summary.md
  - Open /tmp/week-30-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-30/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-30/quiz.html
