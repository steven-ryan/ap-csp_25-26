---
title: Week 15 — Lesson Plan
---
{% include topnav.md %}

# Week 15 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Algorithms — Decomposition & Patterns
...
- Review and merge student PRs for Week 15 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 15 > /tmp/week-15-summary.md
  - Open /tmp/week-15-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-15/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-15/quiz.html
