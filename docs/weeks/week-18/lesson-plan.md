---
title: Week 18 — Lesson Plan
---
{% include topnav.md %}

# Week 18 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Mini‑Project — Integrate Lists + Procedures
...
- Review and merge student PRs for Week 18 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 18 > /tmp/week-18-summary.md
  - Open /tmp/week-18-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-18/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-18/quiz.html
