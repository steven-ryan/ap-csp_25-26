...
- Review and merge student PRs for Week 09 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 09 > /tmp/week-09-summary.md
  - Open /tmp/week-09-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-9/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-9/quiz.html
