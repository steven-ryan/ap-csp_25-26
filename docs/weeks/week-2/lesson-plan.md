...
# Week 2 — MakeCode CSP Wrapper

Primary lesson (MakeCode)
- Use: Continue Unit 1 — Variables/Conditionals
...
- Review and merge student PRs for Week 02 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 02 > /tmp/week-02-summary.md
  - Open /tmp/week-02-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-2/this-week.html
