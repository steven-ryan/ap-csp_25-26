---
title: Week 6 — Lesson Plan
---
{% include topnav.md %}

# Week 6 — MakeCode CSP Wrapper
...
- Review and merge student PRs for Week 06 on GitHub (ensure checks pass).
- Sync local repo:
  - git checkout main && git pull
- Generate a quick summary of student links and before‑class notes (optional):
  - bash scripts/collect_week_submissions.sh 06 > /tmp/week-06-summary.md
  - Open /tmp/week-06-summary.md during class for quick access to links.
- Verify this week’s docs are live:
  - Plan: {{ site.baseurl }}/weeks/week-6/this-week.html
  - Quiz: {{ site.baseurl }}/weeks/week-6/quiz.html
